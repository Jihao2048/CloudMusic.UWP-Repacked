...
点击下载：&nbsp;[1.4.1.0-通用版](../../raw/main/Cloud.Music.UWP.Repacked-1.4.1.0_universal.appxbundle)

最近更新：已重新制作，尽可能还原了原包的特征。不确定是否能否解决Win11显示概率性异常的问题。~~如果无效就没办法了。~~
...
1. 下载 [配套工具包](../../raw/main/tools/certInst.zip) ，务必解压缩所有文件 _(不要在压缩包内打开)_
